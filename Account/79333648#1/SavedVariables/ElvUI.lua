	...
	["profiles"] = {
		["Default"] = {
			...
			["movers"] = {
				...
				["ElvAB_13"] = "BOTTOM,UIParent,BOTTOM,72,38",
				["BuffsMover"] = "TOPRIGHT,ElvUI_MinimapHolder,TOPLEFT,-7,0",
				["RightChatMover"] = "BOTTOMRIGHT,UIParent,BOTTOMRIGHT,-4,32",
				...
				["ElvAB_1"] = "BOTTOM,UIParent,BOTTOM,0,151",
				["ElvAB_2"] = "BOTTOM,UIParent,BOTTOM,0,105",
				["BelowMinimapContainerMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-4,-274",
				["ArenaHeaderMover"] = "BOTTOMRIGHT,ElvUIParent,RIGHT,-106,-166",
				["ElvAB_4"] = "BOTTOM,UIParent,BOTTOM,70,69",
				["ShiftAB"] = "BOTTOM,UIParent,BOTTOM,0,286",
				["MirrorTimer2Mover"] = "TOP,MirrorTimer1,BOTTOM,0,0",
				["ElvAB_3"] = "BOTTOM,UIParent,BOTTOM,0,197",
				["ElvAB_5"] = "BOTTOM,UIParent,BOTTOM,-338,35",
				...
				["ElvAB_6"] = "BOTTOMRIGHT,UIParent,BOTTOMRIGHT,-4,295",
				["TooltipMover"] = "BOTTOMRIGHT,UIParent,BOTTOMRIGHT,-39,58",
				["ElvUF_TankMover"] = "TOPLEFT,ElvUIParent,TOPLEFT,4,-187",
				["BossHeaderMover"] = "BOTTOMRIGHT,ElvUIParent,RIGHT,-106,-166",
				["ElvUF_PetMover"] = "BOTTOMLEFT,UIParent,BOTTOMLEFT,542,307",
				["PetAB"] = "BOTTOM,UIParent,BOTTOM,-304,244",
